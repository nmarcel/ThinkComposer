...
// Object : Instrumind.ThinkComposer.MetaModel.InformationMetaModel.TableType (Class)
//
// Date       Author             Changes
// ---------- ------------------ -------------------------------------------------------------
...
{
    /// <summary>
    /// Defines a type of Table-Record Field for storing Tables, declared by a Table Definition which is either stored or referenced.
    /// </summary>
    [Serializable]
    public class TableType : DataType
    {
        // ---------------------------------------------------------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Constructor.
        /// </summary>
        public TableType(string Name, string TechName, string Summary = "", ImageSource Pictogram = null)
        ...
        public override Type ContainerType { get { return typeof(Table); } }
    }
}