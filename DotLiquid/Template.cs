...
namespace DotLiquid
{
    ...
    public class Template
    {
        ...
        public static Func<object, object> GetValueTypeTransformer(Type type, bool IncludeAncestors = true)
        {
            //$ Changed to work with base types
            do
            {
                ...
                type = type.BaseType;
            } while (IncludeAncestors && type != null);
            
            return null;
        }

        public static Func<object, object> GetSafeTypeTransformer(Type type, bool IncludeAncestors = true)
        {
            //$ Changed to work with base types
            do
            {
