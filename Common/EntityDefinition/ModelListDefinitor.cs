...
{
    /// <summary>
    /// Manages and describes, at a static level, a member list belonging to a model class.
    /// </summary>
    public class ModelListDefinitor<TModelClass, TItem> : MModelCollectionDefinitor where TModelClass : class, IModelClass<TModelClass>
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public ModelListDefinitor(string TechName, EEntityMembership Membership,
                                  Func<TModelClass, EditableList<TItem>> BaseGetter,
                                  Action<TModelClass, EditableList<TItem>> BaseSetter,
                                  string Name, string Summary, bool IsRequired = false, bool IsAdvanced = false)
        ...
        public override Type DataType { get { return typeof(EditableList<TItem>); } }
        ...
        /// <summary>
        /// Getter operation for access the list property from its owning instance.
        /// </summary>
        public Func<TModelClass, EditableList<TItem>> Getter;

        /// <summary>
        /// Function which sets the passed list into the list property of a supplied instance and returns indication of whether the setting was made.
        /// </summary>
        public Func<TModelClass, ModelListDefinitor<TModelClass, TItem>, EditableList<TItem>, bool> Setter { get; protected set; }
        ...
        {
            this.Set((TModelClass)Instance, (EditableList<TItem>)Collection);
        }

        /// <summary>
        /// Returns the controlled list value of the supplied instance.
        /// </summary>
        public EditableList<TItem> Get(TModelClass Instance)
        {
            return this.Getter(Instance);
        }

        /// <summary>
        /// Sets the passed value into the controlled collection of the supplied instance.
        /// Returns indication whether the setting was made.
        /// </summary>
        public bool Set(TModelClass Instance, EditableList<TItem> Collection)
        {
            return this.Setter(Instance, this, Collection);
        }

        /// <summary>
        /// Creates and returns a controller for the defined list.
        /// </summary>
        public ListController<TModelClass, TItem> CreateController(MEntityInstanceController InstanceController)
        {
            var Result = new ListController<TModelClass, TItem>(InstanceController);

            Result.ListDefinitor = this;
